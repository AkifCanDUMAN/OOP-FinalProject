    ...
    public void booksData(String bookName, String userName)
    {
        ...
        try{
            ...
            while (resultSet.next()){
                borrowBookManager.insert(resultSet.getString("BOOK_NAME"),resultSet.getString("AUTHOR_NAME"),resultSet.getString("NUMBER OF PAGE"),resultSet.getString("TYPE"),userName);
                deleteBook(bookName);
            }
        }catch (SQLException exception){
            helper.showErrorMessage(exception);
